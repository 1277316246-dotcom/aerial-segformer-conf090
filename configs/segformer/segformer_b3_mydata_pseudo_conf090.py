...
launcher = 'none'
load_from = '/root/autodl-tmp/mmsegmentation/work_dirs/segformer_b3_mydata_68/best_mIoU_iter_40000.pth'
log_level = 'INFO'
...
train_dataloader = dict(
    batch_size=2,
    dataset=dict(
        ann_file='train_pseudo_conf090.txt',
        data_prefix=dict(
            img_path='JPEGImages', seg_map_path='SegmentationClassV1Conf090'),
        data_root='data/mydata',
        img_suffix='.png',
        pipeline=[
            dict(backend_args=None, type='LoadImageFromFile'),
...
work_dir = '/root/autodl-tmp/mmsegmentation/work_dirs/segformer_b3_mydata_pseudo_conf090'
